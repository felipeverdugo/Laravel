<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="dni" type="text" class="mt-1 block w-full" wire:model.defer="state.dni" readonly disabled />

        </div>
        <!-- fecha nacimiento -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="fecha_nac" value="{{ __('Fecha de nacimiento') }}" />
            <x-jet-input id="fecha_nac" type="date" class="mt-1 block w-full" wire:model.defer="state.fecha_nac" />
